## Olá, meu nome é Eduardo Nascimento, desenvolvedor Front-End e BackpEnd

Sou desenvolvedor Web gosto de tecnologia e inovação, com experiência em criar soluções digitais modernas, responsivas e escaláveis. Trabalho com HTML, CSS, JavaScript, TypeScript, React e Node.js, Express.Js, Sequelize, TailwindCss, Zod, React-Hook-Form, sempre buscando unir performance e design centrado no usuário.
